...
double* TemplateMatching1(char* input,char* templatename,char* output,char* output_txt,double threshold,int isWriteImageResult,unsigned char color,unsigned char red,unsigned char green,unsigned char blue);
double* TemplateMatching2(char* input,char* templatename,char* output,char* output_txt,double threshold,int isWriteImageResult,unsigned char color,unsigned char red,unsigned char green,unsigned char blue);
double* TemplateMatching(char* input,char* templatename,char* output,unsigned char red,unsigned char green,unsigned char blue,double c,double threshold);
